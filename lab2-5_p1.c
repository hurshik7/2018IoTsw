...
int main(void)
{
		...
		while(1)
		{
				MotorControl(LEFT_ROTATE, 128/4); //Duty Cycle 25% 
				delay(2000);
				MotorStop();
				delay(2000);

				MotorControl(LEFT_ROTATE, 128/2);
				delay(2000);
				MotorStop();
				delay(2000);

				MotorControl(LEFT_ROTATE, 128/4*3);
				delay(2000);
				MotorStop();
				delay(2000);
				...
				MotorControl(RIGHT_ROTATE, 128/4*3);
				delay(2000);
				MotorStop();
				delay(2000);

				MotorControl(RIGHT_ROTATE, 128/2);
				delay(2000);
				MotorStop();
				delay(2000);

				MotorControl(RIGHT_ROTATE, 128/4);
				delay(2000);
				MotorStop();
				delay(2000);
